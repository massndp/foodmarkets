                    ...
                    <tbody>
                        ...
                        @forelse ($user as $u)
                            <tr>
                                ...
                                <td class="border px-6 py-4">{{$u->roles}}</td>
                                <td class="border px-6 py-4 text-center">
                                    <a href="{{ route('users.edit', $u->id) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded">
                                        Edit
                                    </a>
                        ...
                        @empty
                            <tr>
                                <td colspan="border text-center p-5">
